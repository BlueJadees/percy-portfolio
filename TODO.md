...
- [ ] Capturas para los placeholders de cada página de proyecto (en `src/assets/img/`):
      Kuppel (dashboard), Logística (Excel), Cobranza (Power BI), HomeLab (Portainer),
      Virals (gameplay), Hunt the Space Dragon (pixel art), Earth-Builder (prototipo 3D),
      Coliseo Smash (setup/escenario), Polysteichon (banda en vivo), Satelite (interfaz),
      Panel IA (galería/bóveda).

## Pendientes de pulido (del CLAUDE.md original)

- [ ] Tagline definitivo del hero (ahora tiene texto provisional + TODO).
- [ ] Favicon personalizado.
- [ ] Meta tags OG (og:title, og:image, og:description).
- [ ] Enlaces reales donde falten (revisar cards de juegos).
